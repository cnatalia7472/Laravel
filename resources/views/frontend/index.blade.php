            ...
            <div id="revolutionSlider" class="slider rev_slider" data-version="5.4.7" data-plugin-revolution-slider data-plugin-options="{'delay': 9000, 'gridwidth': 1170, 'gridheight': 500, 'disableProgressBar': 'on', 'responsiveLevels': [4096,1200,992,500]}">
                <ul>
                    <li data-transition="fade">
                        <img src="{{ asset('assets/frontend/img/slides/slide-bg.jpg') }}"
                             alt=""
                        ...
                        <div class="tp-caption top-label"
                             ...
                             data-y="180"
                             data-start="500"
                             data-transform_in="y:[-300%];opacity:0;s:500;">  ARE YOU SPENDING</div>
                        ...
                        <div class="tp-caption main-label"
                             ...
                             data-mask_in="x:0px;y:0px;">  TOO MUCH MONEY?</div>
                        ...
                        <div class="tp-caption"
                             ...
                             data-y="248"
                             data-start="2500"
                             data-transform_in="z:0;rX:0;rY:0;rZ:0;sX:0.9;sY:0.9;skX:0;skY:0;opacity:0;s:1300;"><img src="{{ asset('assets/frontend/img/slides/slide-concept-2-1.png') }}" alt=""></div>

                        <div class="tp-caption"
                             data-x="['960','960','960','980']"
                             data-y="200"
                             data-start="3500"
                             data-transform_in="y:[300%];opacity:0;s:300;"><img src="{{ asset('assets/frontend/img/slides/slide-concept-2-2.png') }}" alt=""></div>

                        <div class="tp-caption"
                             data-x="['930','930','930','950']"
                             data-y="170"
                             data-start="3650"
                             data-transform_in="y:[300%];opacity:0;s:300;"><img src="{{ asset('assets/frontend/img/slides/slide-concept-2-3.png') }}" alt=""></div>

                        <div class="tp-caption"
                             data-x="['880','880','880','900']"
                             data-y="130"
                             data-start="3750"
                             data-transform_in="y:[300%];opacity:0;s:300;"><img src="{{ asset('assets/frontend/img/slides/slide-concept-2-4.png') }}" alt=""></div>

                        <div class="tp-caption"
                             data-x="['610','610','610','630']"
                             data-y="80"
                             data-start="3950"
                             data-transform_in="y:[300%];opacity:0;s:300;"><img src="{{ asset('assets/frontend/img/slides/slide-concept-2-5.png') }}" alt=""></div>
                    ...
                    <li data-transition="fade">
                        ...
                        <div class="tp-caption top-label"
                             ...
                             data-start="500"
                             data-transform_in="z:0;rX:0;rY:0;rZ:0;sX:0.9;sY:0.9;skX:0;skY:0;opacity:0;s:1000;e:Power2.easeOut;"><img src="{{ asset('assets/frontend/img/slides/slide-concept.png') }}" alt=""></div>
        ...
        <div class="home-intro" id="home-intro">
            <div class="container">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-8">
                        <p>
                            We are the solution to you managed IT needs. <em>You will love us.</em>
                ...
                <div class="row text-center">
                    ...
                    <div class="col-lg-2 ml-lg-auto">
                        <div class="process-image">
                            <img src="{{ asset('assets/frontend/img/home-concept-item-1.png') }}" alt="" />
                            <strong>Strategy</strong>
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="process-image">
                            <img src="{{ asset('assets/frontend/img/home-concept-item-2.png') }}" alt="" />
                            <strong>Planning</strong>
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="process-image">
                            <img src="{{ asset('assets/frontend/img/home-concept-item-3.png') }}" alt="" />
                            <strong>Build</strong>
                        </div>
                    </div>
                    <div class="col-lg-4 ml-lg-auto">
                        <div class="project-image">
                            <div id="fcSlideshow" class="fc-slideshow">
                                <ul class="fc-slides">
                                    <li><a href="portfolio-single-small-slider.html"><img class="img-responsive" src="{{ asset('assets/frontend/img/projects/project-home-1.jpg') }}" alt="" /></a></li>
                                    <li><a href="portfolio-single-small-slider.html"><img class="img-responsive" src="{{ asset('assets/frontend/img/projects/project-home-2.jpg') }}" alt="" /></a></li>
                                    <li><a href="portfolio-single-small-slider.html"><img class="img-responsive" src="{{ asset('assets/frontend/img/projects/project-home-3.jpg') }}" alt="" /></a></li>
                                </ul>
                            </div>
        ...
        <div class="container">
            ...
            <div class="row text-center">
                <div class="owl-carousel owl-theme" data-plugin-options="{'items': 6, 'autoplay': true, 'autoplayTimeout': 3000}">
                    <div>
                        <img class="img-fluid" src="{{ asset('assets/frontend/img/logos/logo-1.png') }}" alt="">
                    </div>
                    <div>
                        <img class="img-fluid" src="{{ asset('assets/frontend/img/logos/logo-2.png') }}" alt="">
                    </div>
                    <div>
                        <img class="img-fluid" src="{{ asset('assets/frontend/img/logos/logo-3.png') }}" alt="">
                    </div>
                    <div>
                        <img class="img-fluid" src="{{ asset('assets/frontend/img/logos/logo-4.png') }}" alt="">
                    </div>
                    <div>
                        <img class="img-fluid" src="{{ asset('assets/frontend/img/logos/logo-5.png') }}" alt="">
                    </div>
                    <div>
                        <img class="img-fluid" src="{{ asset('assets/frontend/img/logos/logo-6.png') }}" alt="">
                    </div>
                    <div>
                        <img class="img-fluid" src="{{ asset('assets/frontend/img/logos/logo-4.png') }}" alt="">
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <article>
                                                ...
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec hendrerit vehicula est, in consequat libero. <a href="/" class="read-more">read more <i class="fas fa-angle-right"></i></a></p>
                                            </article>
                                        </div>
                                        <div class="col-lg-6">
                                            <article>
                                                ...
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec hendrerit vehicula est, in consequat. <a href="/" class="read-more">read more <i class="fas fa-angle-right"></i></a></p>
                                            </article>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <article>
                                                ...
                                                <h4 class="heading-primary"><a href="blog-post.html">Lorem ipsum dolor</a></h4>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. <a href="/" class="read-more">read more <i class="fas fa-angle-right"></i></a></p>
                                            </article>
                                        </div>
                                    </div>
                                    <div class="row">
                                            ...
                                            <div class="testimonial testimonial-primary">
                                                ...
                                                <div class="testimonial-author">
                                                    <div class="testimonial-author-thumbnail img-thumbnail">
                                                        <img src="{{ asset('assets/frontend/img/clients/client-1.jpg') }}" alt="">
                                                    </div>
