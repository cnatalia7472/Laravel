        ...
        <div class="row justify-content-center">
            <div class="card col-md-3">
                <div class="card-header header-elements-inline">
                    <h5 class="card-title">Edit {{ $user->first_name }} {{ $user->last_name }}</h5>
                ...
                <div class="card-body">
                    <form action="{{route('users.store')}}" method="put">
                        @csrf
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <select class="form-control form-control-select2" name="language">
