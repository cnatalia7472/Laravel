...
@section('page-title', ' - Global View | Domains')
@section('javascript-after')
    ...
    <script src="{{ asset('assets/backend/js/pages/gv-domains-datatables.js') }}"></script>
    ...
    <div class="page-header page-header-light">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title d-flex">
                <h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Global View</span> - Domains</h4>
